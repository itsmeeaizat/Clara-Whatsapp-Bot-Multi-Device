...
/**
 * @typedef {Object} ClaraApiAuthShape
 * @property {Object<string, any>} [headers]
 * @property {Object<string, any>} [params]
 */

/**
 * @typedef {Object} ClaraApiProviderShape
 * @property {string} baseURL
 * @property {ClaraApiAuthShape} [auth]
...
/**
 * @typedef {Object} ClaraApiRequestOptions
...
/**
 * @typedef {Object} ClaraApiMultipartFile
 ...
 */
class ClaraApiProvider {
  /**
   * @param {ClaraApiManager} mgr
   * @param {string} name
   */
  ...
  /**
   * @param {string} ep
   * @param {ClaraApiRequestOptions} [opt]
   * @returns {Promise<any>}
   */
  request(ep, opt = {}) {
   ...
   * @param {ClaraApiMultipartFile[]|Object<string, any>} [files]
   * @param {ClaraApiRequestOptions} [opt]
   * @returns {Promise<any>}
   */
...
class CovenantApiProvider extends ClaraApiProvider {
  gpt4(input, opt = {}) {
...
class NeoxrApiProvider extends ClaraApiProvider {
  whatMusic(input, opt = {}) {
...
class CukiApiProvider extends ClaraApiProvider {
...
class ApiFaaProvider extends ClaraApiProvider {
...
class ClaraMainApiProvider extends ClaraApiProvider {
  ytmp4(input, opt = {}) {
...
class NexrayApiProvider extends ClaraApiProvider {
  geminiTts(input, opt = {}) {
...
class YupraApiProvider extends ClaraApiProvider {
  brat(input, opt = {}) {
    return this.get("/api/image/brat", this.asParams(input, "text"), opt);
  }
}

class EmiliabotApiProvider extends ClaraApiProvider {
...
class AzbryApiProvider extends ClaraApiProvider {
...
class YuulabsApiProvider extends ClaraApiProvider {
  tiktok(input, opt = {}) {
    return this.get("/api/downloader/tiktok", this.asParams(input, "url"), opt);
  }
}

class ZenzxzApiProvider extends ClaraApiProvider {
  youtube(input, opt = {}) {
...
class FgsiApiProvider extends ClaraApiProvider {
...
/**
 * API manager terpusat untuk provider eksternal Clara.
 */
class ClaraApiManager {
  /**
  ...
  /**
   * @param {string} name
   * @param {ClaraApiProviderShape} cfg
   * @returns {ClaraApiProvider}
   */
  ...
  /**
   * @param {string} name
   * @param {Partial<ClaraApiProviderShape>} cfg
   * @returns {ClaraApiProvider}
   */
  ...
  makeProviderClient(name) {
    const ProviderClass = this.providerClasses?.[name] || ClaraApiProvider;
...
const claraApi = new ClaraApiManager();

export { ClaraApiManager, ClaraApiProvider, claraApi };
