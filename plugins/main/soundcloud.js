  ...
  try {
    ...
    if (!url) {
      const text =
        ...
        "\n\n" +
        bracketBox("📋", "ɪɴꜰᴏ", [
          `◦ Penggunaan: *${prefix}soundcloud <link>*`,
          `◦ Contoh: *${prefix}soundcloud https://soundcloud.com/artist/track*`,
        ]) +
        "\n\n" +
        separator() +
        "\n" +
    ...
    const text =
      ...
      separator() +
      "\n" +
      tipText(`Ketik ${prefix}soundcloud <link> untuk download lagu lain`) +
      "\n" +
...
export default {
  config: {
    name: "soundcloud",
    alias: ["soundcloud", "sc", "soundclouddownloader"],
    category: "music",
    description: "Cari/download lagu SoundCloud",
