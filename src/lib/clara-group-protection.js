...
import { isLid, lidToJid, lidToJidSafe } from "./clara-lid.js";
    ...
    try {
      ...
      if (msgContent) {
        ...
        if (
          ...
          const { downloadMediaMessage } = await import("clara");
          const fakeMsg = {
            key: cached.key,
          ...
          const { generateWAMessageFromContent } = await import("clara");
          const cleanContent = {};
