...
footer: Powered by Clara AI (opsional)
[/RICH:CODE]
...
[RICH:LIST]
title: Info Bot
rows: Nama | Clara AI;; Versi | 2.4.5;; Developer | Zann
footer: © Clara AI (opsional)
[/RICH:LIST]

5. STICKER (saat user minta sticker, atau untuk ekspresi emosi):
[RICH:STICKER]
url: https://iili.io/BPBdFuj.md.jpg
packname: Clara AI (opsional)
  ...
  try {
    ...
    if (rich.type === "STICKER") {
      ...
      await sock.sendImageAsSticker(jid, stickerInput, quoted, {
        packname: packname || config.bot?.name || "Clara AI",
    ...
    case "STICKER": {
      ...
      await sock.sendMessage(
        m.chat,
        {
          ...
          packname: config.bot?.name || "Clara",
          author: "AutoAI",
        },
        { quoted: m },
      );
